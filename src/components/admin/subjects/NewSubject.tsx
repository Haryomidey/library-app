...
function NewSubject({ idUpdate, contentUpdate }: NewSubjectProps) {
  ...
  const validateInputs = () => {
    ...
    if (!subjectDescription) newErrors.subjectDescription = "Description is required.";
    if (grade.length === 0) newErrors.grade = "At least one grade must be selected.";
    if (selectedCoverPhoto && !["image/jpeg", "image/png", "image/gif"].includes(selectedCoverPhoto.type)) {
      ...
      <form className="flex flex-col gap-6 px-10 py-5">
        ...
        <div className="grid grid-cols-2 gap-10">
          <div className="flex flex-col gap-2">
            ...
            />
            {errors.subjectName && <p className="text-red-500">{errors.subjectName}</p>}
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.teacherId && <p className="text-red-500">{errors.teacherId}</p>}
          </div>
        </div>
