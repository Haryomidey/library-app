...
function LessonDetailsStudent() {
  ...
  const handleRouting = () => {
    route(`/student/subjects/${subjectId}/${grade}/${topicId}/video`);
  };
    ...
    <div>
      ...
      <div className="lg:px-10 px-5 py-5">
        <div className="flex flex-wrap gap-2 text-blue-500 text-sm list-none [&>*]:self-center">
          <li
            onClick={() => {
              route(`/student/subjects/${subjectId}/`);
            }}
          ...
          <li
            className="cursor-pointer"
            onClick={() => {
              route(`/student/subjects/${subjectId}/${grade}`);
            }}
          >
            Grade {grade} &gt;&nbsp;
          </li>
...
export default LessonDetailsStudent;
